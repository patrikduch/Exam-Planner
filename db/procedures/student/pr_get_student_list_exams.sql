...
BEGIN
	SELECT exam_id, 0 AS is_exam_active, EX1.max_participants, C.course_code, C.credits AS course_credits, C.title AS course_title, EX1.exam_start_date, EX1.exam_end_date
	FROM ExamDate EX1
	JOIN Course C
	...
	SELECT exam_id, 1 AS is_exam_active, EX2.max_participants, C.course_code, C.credits AS course_credits, C.title AS course_title, EX2.exam_start_date, EX2.exam_end_date
	FROM ExamDate EX2
	JOIN Course C
